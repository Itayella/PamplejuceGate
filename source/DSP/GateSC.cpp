...
template <typename SampleType>
void NoiseGate<SampleType>::setSideChain (bool sideChainOn)
{
    sideChainOn = scOn;
}
...
//==============================================================================
template <typename SampleType>
void NoiseGate<SampleType>::prepare (const juce::dsp::ProcessSpec& spec)
{
...
//==============================================================================
template <typename SampleType>
SampleType NoiseGate<SampleType>::processSample (int channel, SampleType sample, SampleType sampleSC)
{
    // RMS ballistics filter
    auto envSC = RMSFilter.processSample (channel, sampleSC);

    // Ballistics filter
    auto env = envelopeFilter.processSample (channel, envSC);
